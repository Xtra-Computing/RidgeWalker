...
#pragma HLS stream variable=debug_stream  depth=2
        ...
        state_instance(in3, debug_stream[3 - 1]);
        state_instance(in4, debug_stream[4 - 1]);
        state_instance(in5, debug_stream[5 - 1]);
        state_instance(in6, debug_stream[6 - 1]);
        state_instance(in7, debug_stream[7 - 1]);
        state_instance(in8, debug_stream[8 - 1]);
