...
void sink_instance(uint32_t num_last, uint32_t nolast, uint32_t max_size, sample_task_stream_t &in,
...
extern "C" {
    void router_sink( ap_uint<64>                     *mem,
                      ...
                      sample_task_stream_t      &in1,
                      sample_task_stream_t      &in2,
                      sample_task_stream_t      &in3,
                      sample_task_stream_t      &in4,
                      sample_task_stream_t      &in5,
                      sample_task_stream_t      &in6,
                      sample_task_stream_t      &in7,
                      sample_task_stream_t      &in8
