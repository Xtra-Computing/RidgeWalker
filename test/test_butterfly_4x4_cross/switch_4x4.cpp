...
extern "C" {
    void switch_4x4(
        ...
        default_route_x4_stream_t &rin,
        default_route_x4_stream_t &rout
    )
    {
...
#pragma HLS stream variable=filtered_x2_stream  depth=12
        ...
        default_route_x4_frp_inner_stream_t  remote_in;
...
#pragma HLS stream variable=out_stream  depth=12
        ...
        free_run_axis_to_frp_stream< FRP_TEMPLATE(default_route_x4) >(rin, remote_in);


        dispatch_remote_package< default_route_x4_frp_item_t, default_route_frp_item_t, default_route_x2_item_t >(
...
#pragma HLS unroll
        ...
        free_run_frp_to_axis_stream< FRP_TEMPLATE(default_route_x4) >(remote_out, rout);
