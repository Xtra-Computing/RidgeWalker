...
wire   [0:0] tmp_i_183_nbreadreq_fu_120_p3;
reg    ap_predicate_op38_read_state1;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] repd_state_load_reg_321;
reg   [0:0] tmp_i_183_reg_332;
reg   [0:0] response_drop_V_load_reg_325;
reg    ap_predicate_op54_write_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_state2_io;
reg   [0:0] repd_state_load_reg_321_pp0_iter1_reg;
reg   [0:0] tmp_i_183_reg_332_pp0_iter1_reg;
reg   [0:0] response_drop_V_load_reg_325_pp0_iter1_reg;
...
wire   [511:0] currWord_data_V_fu_259_p1;
reg   [511:0] currWord_data_V_reg_336;
reg   [63:0] currWord_keep_V_reg_341;
wire   [0:0] currWord_last_V_fu_273_p3;
reg   [0:0] currWord_last_V_reg_346;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_183_nbreadreq_fu_120_p3 == 1'd1) & (repd_state == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        currWord_data_V_reg_336 <= currWord_data_V_fu_259_p1;
        currWord_keep_V_reg_341 <= {{ureDataPayload_dout[575:512]}};
        currWord_last_V_reg_346 <= ureDataPayload_dout[1024'd576];
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_i_nbreadreq_fu_106_p3 == 1'd1) & (repd_state == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        response_drop_V <= rthDropFifo_dout[160'd128];
...
always @ (*) begin
    ap_condition_183 = ((tmp_i_183_nbreadreq_fu_120_p3 == 1'd1) & (repd_state == 1'd1) & (currWord_last_V_fu_273_p3 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op38_read_state1 = ((tmp_i_183_nbreadreq_fu_120_p3 == 1'd1) & (repd_state == 1'd1));
end

always @ (*) begin
    ap_predicate_op54_write_state2 = ((response_drop_V_load_reg_325 == 1'd0) & (tmp_i_183_reg_332 == 1'd1) & (repd_state_load_reg_321 == 1'd1));
end

always @ (*) begin
    ap_predicate_op55_write_state3 = ((response_drop_V_load_reg_325_pp0_iter1_reg == 1'd0) & (tmp_i_183_reg_332_pp0_iter1_reg == 1'd1) & (repd_state_load_reg_321_pp0_iter1_reg == 1'd1));
end

assign currWord_data_V_fu_259_p1 = ureDataPayload_dout[511:0];

assign currWord_last_V_fu_273_p3 = ureDataPayload_dout[1024'd576];

assign tmp_i_183_nbreadreq_fu_120_p3 = ureDataPayload_empty_n;
