...
reg   [35:0] reg_234;
wire   [223:0] trunc_ln628_11_fu_242_p1;
reg   [223:0] trunc_ln628_11_reg_567;
wire   [27:0] trunc_ln628_12_fu_246_p1;
reg   [27:0] trunc_ln628_12_reg_572;
wire   [0:0] grp_fu_206_p1;
reg   [7:0] tmp_i_reg_588;
reg   [7:0] tmp_36_i_reg_593;
reg   [7:0] tmp_37_i_reg_598;
reg   [7:0] tmp_38_i_reg_603;
reg   [7:0] tmp_39_i_reg_608;
reg   [7:0] tmp_40_i_reg_613;
reg   [7:0] tmp_41_i_reg_618;
reg   [7:0] tmp_42_i_reg_623;
reg   [7:0] tmp_43_i_reg_628;
reg   [7:0] tmp_44_i_reg_633;
reg   [7:0] tmp_45_i_reg_638;
reg   [7:0] tmp_46_i_reg_643;
wire   [0:0] ap_phi_reg_pp0_iter0_sendWord_last_V_reg_182;
reg   [0:0] ap_phi_reg_pp0_iter1_sendWord_last_V_reg_182;
wire   [0:0] tmp_3_fu_250_p3;
wire   [511:0] p_Result_s_fu_418_p5;
wire   [511:0] zext_ln368_fu_496_p1;
wire   [63:0] p_Result_12_fu_436_p5;
wire   [63:0] zext_ln368_2_fu_500_p1;
wire   [1023:0] zext_ln169_fu_466_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln176_fu_491_p1;
wire   [1023:0] zext_ln139_fu_539_p1;
wire   [35:0] trunc_ln628_10_fu_414_p1;
wire   [287:0] trunc_ln628_fu_410_p1;
wire   [576:0] tmp_12_i_fu_454_p6;
wire   [35:0] trunc_ln176_fu_475_p1;
wire   [287:0] trunc_ln368_fu_471_p1;
...
always @ (posedge ap_clk) begin
    if (((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (real_start == 1'b1) & (tmp_3_fu_250_p3 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (grp_fu_206_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ap_phi_reg_pp0_iter1_sendWord_last_V_reg_182 <= 1'd1;
    end else if ((((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (real_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (grp_fu_206_p1 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (real_start == 1'b1) & (tmp_3_fu_250_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (grp_fu_206_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        ap_phi_reg_pp0_iter1_sendWord_last_V_reg_182 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_215)) begin
        ...
        end else if (((tmp_1_reg_560 == 1'd1) & (ure_state_load_reg_556 == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_36_i_reg_593 <= {{rxUdpDataIn_TDATA_int_regslice[119:112]}};
        tmp_37_i_reg_598 <= {{rxUdpDataIn_TDATA_int_regslice[111:104]}};
        tmp_38_i_reg_603 <= {{rxUdpDataIn_TDATA_int_regslice[103:96]}};
        tmp_39_i_reg_608 <= {{rxUdpDataIn_TDATA_int_regslice[159:152]}};
        tmp_40_i_reg_613 <= {{rxUdpDataIn_TDATA_int_regslice[151:144]}};
        tmp_41_i_reg_618 <= {{rxUdpDataIn_TDATA_int_regslice[143:136]}};
        tmp_42_i_reg_623 <= {{rxUdpDataIn_TDATA_int_regslice[135:128]}};
        tmp_43_i_reg_628 <= {{rxUdpDataIn_TDATA_int_regslice[175:168]}};
        tmp_44_i_reg_633 <= {{rxUdpDataIn_TDATA_int_regslice[167:160]}};
        tmp_45_i_reg_638 <= {{rxUdpDataIn_TDATA_int_regslice[191:184]}};
        tmp_46_i_reg_643 <= {{rxUdpDataIn_TDATA_int_regslice[183:176]}};
        tmp_i_reg_588 <= {{rxUdpDataIn_TDATA_int_regslice[127:120]}};
    end
end
...
always @ (*) begin
    ap_condition_213 = ((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (tmp_3_fu_250_p3 == 1'd1) & (grp_fu_206_p1 == 1'd1));
end
...
always @ (*) begin
    ap_condition_217 = ((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (tmp_3_fu_250_p3 == 1'd0) & (grp_fu_206_p1 == 1'd1));
end
...
always @ (*) begin
    ap_condition_95 = (~(ure_state_load_reg_556 == 2'd2) & ~(ure_state_load_reg_556 == 2'd1) & (tmp_reg_580 == 1'd1));
end
...
assign ap_phi_reg_pp0_iter0_sendWord_last_V_reg_182 = 'bx;
...
always @ (*) begin
    ap_predicate_op70_write_state2 = ((tmp_1_reg_560 == 1'd1) & (ure_state_load_reg_556 == 2'd1));
end
...
always @ (*) begin
    ap_predicate_op82_write_state2 = (~(ure_state_load_reg_556 == 2'd2) & ~(ure_state_load_reg_556 == 2'd1) & (tmp_reg_580 == 1'd1));
end

always @ (*) begin
    ap_predicate_op85_write_state2 = (~(ure_state_load_reg_556 == 2'd2) & ~(ure_state_load_reg_556 == 2'd1) & (tmp_reg_580 == 1'd1) & (tmp_last_V_reg_584 == 1'd1));
end
...
assign p_Result_12_fu_436_p5 = {{prevWord_keep_V_1[63:36]}, {reg_234}};

assign p_Result_s_fu_418_p5 = {{prevWord_data_V_1[511:288]}, {reg_230}};

assign rxUdpDataIn_TREADY = regslice_both_rxUdpDataIn_V_data_V_U_ack_in;

assign start_out = real_start;

assign tmp_12_i_fu_454_p6 = {{{{{ap_phi_reg_pp0_iter1_sendWord_last_V_reg_182}, {trunc_ln628_12_reg_572}}, {trunc_ln628_10_fu_414_p1}}, {trunc_ln628_11_reg_567}}, {trunc_ln628_fu_410_p1}};

assign tmp_3_fu_250_p3 = rxUdpDataIn_TKEEP_int_regslice[32'd28];

assign trunc_ln176_fu_475_p1 = prevWord_keep_V_1[35:0];

assign trunc_ln368_fu_471_p1 = prevWord_data_V_1[287:0];

assign trunc_ln628_10_fu_414_p1 = prevWord_keep_V_1[35:0];

assign trunc_ln628_11_fu_242_p1 = rxUdpDataIn_TDATA_int_regslice[223:0];

assign trunc_ln628_12_fu_246_p1 = rxUdpDataIn_TKEEP_int_regslice[27:0];

assign trunc_ln628_fu_410_p1 = prevWord_data_V_1[287:0];

assign ureMetaData_din = zext_ln137_cast_fu_504_p14;

assign zext_ln137_cast_fu_504_p14 = {{{{{{{{{{{{{{{{{{{{{{{{1'd1}, {tmp_46_i_reg_643}}}, {tmp_45_i_reg_638}}}, {tmp_44_i_reg_633}}}, {tmp_43_i_reg_628}}}, {tmp_42_i_reg_623}}}, {tmp_41_i_reg_618}}}, {tmp_40_i_reg_613}}}, {tmp_39_i_reg_608}}}, {tmp_38_i_reg_603}}}, {tmp_37_i_reg_598}}}, {tmp_36_i_reg_593}}}, {tmp_i_reg_588}};
...
assign zext_ln176_cast_fu_479_p5 = {{{{{{29'd268435456}, {trunc_ln176_fu_475_p1}}}, {224'd0}}}, {trunc_ln368_fu_471_p1}};

assign zext_ln176_fu_491_p1 = zext_ln176_cast_fu_479_p5;

assign zext_ln368_2_fu_500_p1 = reg_234;

assign zext_ln368_fu_496_p1 = reg_230;
