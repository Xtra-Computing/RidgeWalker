...
wire   [0:0] tmp_9_i_nbreadreq_fu_158_p3;
...
wire   [511:0] zext_ln347_1_fu_427_p1;
wire   [511:0] zext_ln347_fu_494_p1;
wire   [47:0] trunc_ln122_fu_249_p1;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] xor_ln1019_fu_381_p2;
wire   [31:0] and_ln1019_fu_387_p2;
wire   [0:0] icmp_ln1019_fu_393_p2;
wire   [31:0] auxQueryIP_V_2_fu_399_p3;
wire   [430:0] p_Result_s_fu_407_p9;
wire   [430:0] p_Result_1_fu_464_p14;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & (tmp_i_nbreadreq_fu_150_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        aps_fsmState <= 2'd1;
    end else if ((~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & (tmp_9_i_nbreadreq_fu_158_p3 == 1'd1) & (tmp_i_nbreadreq_fu_150_p3 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        aps_fsmState <= 2'd2;
...
always @ (posedge ap_clk) begin
    if ((~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & (tmp_9_i_nbreadreq_fu_158_p3 == 1'd1) & (tmp_i_nbreadreq_fu_150_p3 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign and_ln1019_fu_387_p2 = (xor_ln1019_fu_381_p2 & networkMask_dout);
...
always @ (*) begin
    ap_predicate_op12_read_state1 = (~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & (tmp_9_i_nbreadreq_fu_158_p3 == 1'd1) & (tmp_i_nbreadreq_fu_150_p3 == 1'd0));
end
...
assign auxQueryIP_V_2_fu_399_p3 = ((icmp_ln1019_fu_393_p2[0:0] == 1'b1) ? inputIP_V : gatewayIP_dout);

assign icmp_ln1019_fu_393_p2 = ((and_ln1019_fu_387_p2 == 32'd0) ? 1'b1 : 1'b0);

assign p_Result_1_fu_464_p14 = {{{{{{{{{{{{{{{{{{{{{{{{95'd21438213421863513942334111744}, {replyMeta_protoAddrSrc_V}}}, {replyMeta_hwAddrSrc_V}}}, {myIpAddress_dout}}}, {myMacAddress_dout}}}, {16'd512}}}, {replyMeta_protoLen_V}}}, {replyMeta_hwLen_V}}}, {replyMeta_protoType_V}}}, {replyMeta_hwType_V}}}, {replyMeta_ethType_V}}}, {myMacAddress_dout}}}, {replyMeta_srcMac_V}};

assign p_Result_s_fu_407_p9 = {{{{{{{{{{{{{{95'd21438213421863513942334111744}, {auxQueryIP_V_2_fu_399_p3}}}, {48'd0}}}, {myIpAddress_dout}}}, {myMacAddress_dout}}}, {80'd4722656402130033706504}}}, {myMacAddress_dout}}}, {48'd281474976710655}};

assign tmp_9_i_nbreadreq_fu_158_p3 = arpRequestFifo_empty_n;

assign tmp_i_nbreadreq_fu_150_p3 = arpReplyFifo_empty_n;

assign trunc_ln122_fu_249_p1 = arpReplyFifo_dout[47:0];

assign xor_ln1019_fu_381_p2 = (myIpAddress_dout ^ inputIP_V);

assign zext_ln347_1_fu_427_p1 = p_Result_s_fu_407_p9;

assign zext_ln347_fu_494_p1 = p_Result_1_fu_464_p14;
