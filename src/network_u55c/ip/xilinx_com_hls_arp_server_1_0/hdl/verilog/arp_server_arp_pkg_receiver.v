...
reg    ap_idle_pp0;
wire   [0:0] tmp_nbreadreq_fu_136_p6;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] tmp_reg_352;
reg   [0:0] icmp_ln1019_reg_356;
...
wire   [0:0] icmp_ln1019_fu_202_p2;
wire   [0:0] and_ln74_fu_260_p2;
wire   [0:0] and_ln76_fu_272_p2;
reg   [47:0] meta_srcMac_V_reg_360;
reg   [47:0] meta_hwAddrSrc_V_reg_365;
reg   [47:0] tmp_7_i_reg_378;
reg   [63:0] tmp_9_i_reg_383;
wire   [3:0] select_ln80_fu_304_p3;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] opCode_V_fu_218_p4;
wire   [31:0] protoAddrDst_V_fu_238_p4;
wire   [0:0] icmp_ln1019_2_fu_248_p2;
wire   [0:0] icmp_ln1019_3_fu_254_p2;
wire   [0:0] icmp_ln1019_4_fu_266_p2;
wire   [3:0] add_ln840_fu_298_p2;
wire   [96:0] zext_ln77_cast_fu_318_p5;
wire   [223:0] tmp_10_i_fu_334_p7;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_nbreadreq_fu_136_p6 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1019_fu_202_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        and_ln74_reg_370 <= and_ln74_fu_260_p2;
        meta_hwAddrSrc_V_reg_365 <= {{arpDataIn_TDATA_int_regslice[223:176]}};
        meta_srcMac_V_reg_360 <= {{arpDataIn_TDATA_int_regslice[95:48]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'd0 == and_ln74_fu_260_p2) & (tmp_nbreadreq_fu_136_p6 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1019_fu_202_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        and_ln76_reg_374 <= and_ln76_fu_272_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_nbreadreq_fu_136_p6 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        icmp_ln1019_reg_356 <= icmp_ln1019_fu_202_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((((1'd1 == and_ln74_fu_260_p2) & (tmp_nbreadreq_fu_136_p6 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1019_fu_202_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((1'd0 == and_ln74_fu_260_p2) & (1'd1 == and_ln76_fu_272_p2) & (tmp_nbreadreq_fu_136_p6 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1019_fu_202_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        reg_185 <= {{arpDataIn_TDATA_int_regslice[255:224]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'd1 == and_ln74_fu_260_p2) & (tmp_nbreadreq_fu_136_p6 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1019_fu_202_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_7_i_reg_378 <= {{arpDataIn_TDATA_int_regslice[223:176]}};
        tmp_9_i_reg_383 <= {{arpDataIn_TDATA_int_regslice[159:96]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_nbreadreq_fu_136_p6 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((ap_done_reg == 1'b0) & (tmp_nbreadreq_fu_136_p6 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
assign add_ln840_fu_298_p2 = (wordCount_V + 4'd1);

assign and_ln74_fu_260_p2 = (icmp_ln1019_3_fu_254_p2 & icmp_ln1019_2_fu_248_p2);

assign and_ln76_fu_272_p2 = (icmp_ln1019_4_fu_266_p2 & icmp_ln1019_3_fu_254_p2);
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | (myIpAddress_c_full_n == 1'b0) | (myIpAddress_c11_full_n == 1'b0) | ((tmp_nbreadreq_fu_136_p6 == 1'd1) & (arpDataIn_TVALID_int_regslice == 1'b0)));
end
...
always @ (*) begin
    ap_predicate_op50_write_state2 = ((1'd0 == and_ln74_reg_370) & (icmp_ln1019_reg_356 == 1'd1) & (tmp_reg_352 == 1'd1) & (1'd1 == and_ln76_reg_374));
end

always @ (*) begin
    ap_predicate_op54_write_state2 = ((icmp_ln1019_reg_356 == 1'd1) & (tmp_reg_352 == 1'd1) & (1'd1 == and_ln74_reg_370));
end

assign arpDataIn_TREADY = regslice_both_arpDataIn_V_data_V_U_ack_in;

assign arpReplyFifo_din = tmp_10_i_fu_334_p7;

assign arpTableInsertFifo_din = zext_ln77_cast_fu_318_p5;

assign icmp_ln1019_2_fu_248_p2 = ((opCode_V_fu_218_p4 == 16'd256) ? 1'b1 : 1'b0);

assign icmp_ln1019_3_fu_254_p2 = ((protoAddrDst_V_fu_238_p4 == myIpAddress) ? 1'b1 : 1'b0);

assign icmp_ln1019_4_fu_266_p2 = ((opCode_V_fu_218_p4 == 16'd512) ? 1'b1 : 1'b0);

assign icmp_ln1019_fu_202_p2 = ((wordCount_V == 4'd0) ? 1'b1 : 1'b0);

assign myIpAddress_c11_din = myIpAddress;

assign myIpAddress_c_din = myIpAddress;

assign opCode_V_fu_218_p4 = {{arpDataIn_TDATA_int_regslice[175:160]}};

assign protoAddrDst_V_fu_238_p4 = {{arpDataIn_TDATA_int_regslice[335:304]}};

assign select_ln80_fu_304_p3 = ((arpDataIn_TLAST_int_regslice[0:0] == 1'b1) ? 4'd0 : add_ln840_fu_298_p2);

assign tmp_10_i_fu_334_p7 = {{{{{{reg_185}, {16'd0}}, {tmp_7_i_reg_378}}, {tmp_9_i_reg_383}}, {16'd0}}, {meta_srcMac_V_reg_360}};

assign tmp_nbreadreq_fu_136_p6 = arpDataIn_TVALID_int_regslice;

assign zext_ln77_cast_fu_318_p5 = {{{{{{1'd1}, {reg_185}}}, {16'd0}}}, {meta_hwAddrSrc_V_reg_365}};
