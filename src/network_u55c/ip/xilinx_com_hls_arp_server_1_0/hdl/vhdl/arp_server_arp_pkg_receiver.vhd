...
attribute shreg_extract : string;
    ...
    signal tmp_nbreadreq_fu_136_p6 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_done_reg : STD_LOGIC := '0';
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal tmp_reg_352 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1019_reg_356 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln1019_fu_202_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln74_fu_260_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln76_fu_272_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal meta_srcMac_V_reg_360 : STD_LOGIC_VECTOR (47 downto 0);
    signal meta_hwAddrSrc_V_reg_365 : STD_LOGIC_VECTOR (47 downto 0);
    signal tmp_7_i_reg_378 : STD_LOGIC_VECTOR (47 downto 0);
    signal tmp_9_i_reg_383 : STD_LOGIC_VECTOR (63 downto 0);
    signal select_ln80_fu_304_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal opCode_V_fu_218_p4 : STD_LOGIC_VECTOR (15 downto 0);
    signal protoAddrDst_V_fu_238_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln1019_2_fu_248_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1019_3_fu_254_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1019_4_fu_266_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln840_fu_298_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln77_cast_fu_318_p5 : STD_LOGIC_VECTOR (96 downto 0);
    signal tmp_10_i_fu_334_p7 : STD_LOGIC_VECTOR (223 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1019_fu_202_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                and_ln74_reg_370 <= and_ln74_fu_260_p2;
                meta_hwAddrSrc_V_reg_365 <= arpDataIn_TDATA_int_regslice(223 downto 176);
                meta_srcMac_V_reg_360 <= arpDataIn_TDATA_int_regslice(95 downto 48);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_0 = and_ln74_fu_260_p2) and (tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1019_fu_202_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln1019_reg_356 <= icmp_ln1019_fu_202_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_lv1_1 = and_ln74_fu_260_p2) and (tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1019_fu_202_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((ap_const_lv1_0 = and_ln74_fu_260_p2) and (ap_const_lv1_1 = and_ln76_fu_272_p2) and (tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1019_fu_202_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = and_ln74_fu_260_p2) and (tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1019_fu_202_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_7_i_reg_378 <= arpDataIn_TDATA_int_regslice(223 downto 176);
                tmp_9_i_reg_383 <= arpDataIn_TDATA_int_regslice(159 downto 96);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_reg_352 <= tmp_nbreadreq_fu_136_p6;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                wordCount_V <= select_ln80_fu_304_p3;
            end if;
        end if;
    end process;
    ...
    add_ln840_fu_298_p2 <= std_logic_vector(unsigned(wordCount_V) + unsigned(ap_const_lv4_1));
    and_ln74_fu_260_p2 <= (icmp_ln1019_3_fu_254_p2 and icmp_ln1019_2_fu_248_p2);
    and_ln76_fu_272_p2 <= (icmp_ln1019_4_fu_266_p2 and icmp_ln1019_3_fu_254_p2);
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, myIpAddress_c11_full_n, myIpAddress_c_full_n, tmp_nbreadreq_fu_136_p6, ap_done_reg, arpTableInsertFifo_full_n, ap_predicate_op50_write_state2, arpReplyFifo_full_n, ap_predicate_op54_write_state2, arpDataIn_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ap_predicate_op54_write_state2 = ap_const_boolean_1) and (arpReplyFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op50_write_state2 = ap_const_boolean_1) and (arpTableInsertFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or (myIpAddress_c_full_n = ap_const_logic_0) or (myIpAddress_c11_full_n = ap_const_logic_0) or ((tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (arpDataIn_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, myIpAddress_c11_full_n, myIpAddress_c_full_n, tmp_nbreadreq_fu_136_p6, ap_done_reg, arpTableInsertFifo_full_n, ap_predicate_op50_write_state2, arpReplyFifo_full_n, ap_predicate_op54_write_state2, arpDataIn_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, myIpAddress_c11_full_n, myIpAddress_c_full_n, tmp_nbreadreq_fu_136_p6, ap_done_reg, arpTableInsertFifo_full_n, ap_predicate_op50_write_state2, arpReplyFifo_full_n, ap_predicate_op54_write_state2, arpDataIn_TVALID_int_regslice)
    begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(myIpAddress_c11_full_n, myIpAddress_c_full_n, tmp_nbreadreq_fu_136_p6, ap_done_reg, arpDataIn_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or (myIpAddress_c_full_n = ap_const_logic_0) or (myIpAddress_c11_full_n = ap_const_logic_0) or ((tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (arpDataIn_TVALID_int_regslice = ap_const_logic_0)));
    end process;
    ...
    ap_predicate_op50_write_state2_assign_proc : process(tmp_reg_352, icmp_ln1019_reg_356, and_ln74_reg_370, and_ln76_reg_374)
    begin
                ap_predicate_op50_write_state2 <= ((ap_const_lv1_0 = and_ln74_reg_370) and (icmp_ln1019_reg_356 = ap_const_lv1_1) and (tmp_reg_352 = ap_const_lv1_1) and (ap_const_lv1_1 = and_ln76_reg_374));
    end process;


    ap_predicate_op54_write_state2_assign_proc : process(tmp_reg_352, icmp_ln1019_reg_356, and_ln74_reg_370)
    begin
                ap_predicate_op54_write_state2 <= ((icmp_ln1019_reg_356 = ap_const_lv1_1) and (tmp_reg_352 = ap_const_lv1_1) and (ap_const_lv1_1 = and_ln74_reg_370));
    end process;
    ...
    arpDataIn_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_136_p6, ap_done_reg, ap_block_pp0_stage0, arpDataIn_TVALID_int_regslice)
    begin
        if (((ap_done_reg = ap_const_logic_0) and (tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    arpDataIn_TREADY_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_136_p6, ap_block_pp0_stage0_11001)
    begin
        if (((tmp_nbreadreq_fu_136_p6 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    arpReplyFifo_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_10_i_fu_334_p7),256));
    ...
    icmp_ln1019_2_fu_248_p2 <= "1" when (opCode_V_fu_218_p4 = ap_const_lv16_100) else "0";
    icmp_ln1019_3_fu_254_p2 <= "1" when (protoAddrDst_V_fu_238_p4 = myIpAddress) else "0";
    icmp_ln1019_4_fu_266_p2 <= "1" when (opCode_V_fu_218_p4 = ap_const_lv16_200) else "0";
    icmp_ln1019_fu_202_p2 <= "1" when (wordCount_V = ap_const_lv4_0) else "0";
    ...
    opCode_V_fu_218_p4 <= arpDataIn_TDATA_int_regslice(175 downto 160);
    protoAddrDst_V_fu_238_p4 <= arpDataIn_TDATA_int_regslice(335 downto 304);
    select_ln80_fu_304_p3 <= 
        ap_const_lv4_0 when (arpDataIn_TLAST_int_regslice(0) = '1') else 
        add_ln840_fu_298_p2;
    tmp_10_i_fu_334_p7 <= (((((reg_185 & ap_const_lv16_0) & tmp_7_i_reg_378) & tmp_9_i_reg_383) & ap_const_lv16_0) & meta_srcMac_V_reg_360);
    tmp_nbreadreq_fu_136_p6 <= (0=>(arpDataIn_TVALID_int_regslice), others=>'-');
    zext_ln77_cast_fu_318_p5 <= (((ap_const_lv1_1 & reg_185) & ap_const_lv16_0) & meta_hwAddrSrc_V_reg_365);
end behav;
