...
attribute shreg_extract : string;
    ...
    signal tmp_nbreadreq_fu_66_p6 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln1019_reg_240 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln1019_reg_240_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal dst_ip_addr_V_fu_149_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal dst_ip_addr_V_reg_230 : STD_LOGIC_VECTOR (31 downto 0);
    signal lhs_V_1_reg_235 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln1019_fu_171_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_last_V_2_reg_244 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal xor_ln1019_fu_159_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln1019_fu_165_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                icmp_ln1019_reg_240_pp0_iter1_reg <= icmp_ln1019_reg_240;
                tmp_reg_221 <= tmp_nbreadreq_fu_66_p6;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                dst_ip_addr_V_reg_230 <= dataIn_TDATA_int_regslice(159 downto 128);
                icmp_ln1019_reg_240 <= icmp_ln1019_fu_171_p2;
                lhs_V_1_reg_235 <= regDefaultGateway;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_0) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_last_V_2_reg_244 <= dataIn_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_0) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_last_V_reg_225 <= dataIn_TLAST_int_regslice;
            end if;
        end if;
    end process;
    ...
    and_ln1019_fu_165_p2 <= (xor_ln1019_fu_159_p2 and regSubNetMask);
    ...
    ap_condition_395_assign_proc : process(real_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_66_p6, ap_block_pp0_stage0_11001)
    begin
                ap_condition_395 <= ((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (real_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001));
    end process;
    ...
    ap_predicate_op20_read_state1_assign_proc : process(tmp_nbreadreq_fu_66_p6, bmr_fsm_state)
    begin
                ap_predicate_op20_read_state1 <= ((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_0));
    end process;


    ap_predicate_op37_read_state1_assign_proc : process(tmp_nbreadreq_fu_66_p6, bmr_fsm_state)
    begin
                ap_predicate_op37_read_state1 <= ((tmp_nbreadreq_fu_66_p6 = ap_const_lv1_1) and (bmr_fsm_state = ap_const_lv1_1));
    end process;


    ap_predicate_op46_write_state2_assign_proc : process(bmr_fsm_state_load_reg_217, tmp_reg_221, icmp_ln1019_reg_240)
    begin
                ap_predicate_op46_write_state2 <= ((icmp_ln1019_reg_240 = ap_const_lv1_0) and (tmp_reg_221 = ap_const_lv1_1) and (bmr_fsm_state_load_reg_217 = ap_const_lv1_0));
    end process;


    ap_predicate_op47_write_state2_assign_proc : process(bmr_fsm_state_load_reg_217, tmp_reg_221, icmp_ln1019_reg_240)
    begin
                ap_predicate_op47_write_state2 <= ((icmp_ln1019_reg_240 = ap_const_lv1_1) and (tmp_reg_221 = ap_const_lv1_1) and (bmr_fsm_state_load_reg_217 = ap_const_lv1_0));
    end process;


    ap_predicate_op50_write_state2_assign_proc : process(bmr_fsm_state_load_reg_217, tmp_reg_221)
    begin
                ap_predicate_op50_write_state2 <= ((tmp_reg_221 = ap_const_lv1_1) and (bmr_fsm_state_load_reg_217 = ap_const_lv1_0));
    end process;


    ap_predicate_op53_write_state2_assign_proc : process(bmr_fsm_state_load_reg_217, tmp_reg_221)
    begin
                ap_predicate_op53_write_state2 <= ((tmp_reg_221 = ap_const_lv1_1) and (bmr_fsm_state_load_reg_217 = ap_const_lv1_1));
    end process;


    ap_predicate_op54_write_state3_assign_proc : process(bmr_fsm_state_load_reg_217_pp0_iter1_reg, tmp_reg_221_pp0_iter1_reg, icmp_ln1019_reg_240_pp0_iter1_reg)
    begin
                ap_predicate_op54_write_state3 <= ((icmp_ln1019_reg_240_pp0_iter1_reg = ap_const_lv1_0) and (tmp_reg_221_pp0_iter1_reg = ap_const_lv1_1) and (bmr_fsm_state_load_reg_217_pp0_iter1_reg = ap_const_lv1_0));
    end process;


    ap_predicate_op56_write_state3_assign_proc : process(bmr_fsm_state_load_reg_217_pp0_iter1_reg, tmp_reg_221_pp0_iter1_reg, icmp_ln1019_reg_240_pp0_iter1_reg)
    begin
                ap_predicate_op56_write_state3 <= ((icmp_ln1019_reg_240_pp0_iter1_reg = ap_const_lv1_1) and (tmp_reg_221_pp0_iter1_reg = ap_const_lv1_1) and (bmr_fsm_state_load_reg_217_pp0_iter1_reg = ap_const_lv1_0));
    end process;
    ...
    arpTableRequest_TDATA_int_regslice_assign_proc : process(ap_predicate_op46_write_state2, ap_predicate_op47_write_state2, dst_ip_addr_V_reg_230, lhs_V_1_reg_235, ap_condition_245)
    begin
        if ((ap_const_boolean_1 = ap_condition_245)) then
            if ((ap_predicate_op47_write_state2 = ap_const_boolean_1)) then 
                arpTableRequest_TDATA_int_regslice <= dst_ip_addr_V_reg_230;
            elsif ((ap_predicate_op46_write_state2 = ap_const_boolean_1)) then 
                arpTableRequest_TDATA_int_regslice <= lhs_V_1_reg_235;
            else 
    ...
    dst_ip_addr_V_fu_149_p4 <= dataIn_TDATA_int_regslice(159 downto 128);
    grp_fu_133_p1 <= dataIn_TLAST_int_regslice;
    icmp_ln1019_fu_171_p2 <= "1" when (and_ln1019_fu_165_p2 = ap_const_lv32_0) else "0";
    ...
    tmp_3_i_fu_203_p4 <= ((tmp_last_V_2_reg_244 & reg_141) & reg_137);
    tmp_4_i_fu_189_p4 <= ((tmp_last_V_reg_225 & reg_141) & reg_137);
    tmp_nbreadreq_fu_66_p6 <= (0=>(dataIn_TVALID_int_regslice), others=>'-');
    xor_ln1019_fu_159_p2 <= (regDefaultGateway xor dst_ip_addr_V_fu_149_p4);
end behav;
