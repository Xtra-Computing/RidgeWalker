...
void rpa_out_frp(     mem_access_stream_t(64)                     &in_data,
...
extern "C" {
    void rpa_out(     mem_access_stream_t(64)         &in_data_0,
...
#pragma HLS stream variable=frp_out  depth=13
        ...
        rpa_out_frp(in_data_0, in_vds_0, inner_connection_g1[0]);
        rpa_out_frp(in_data_1, in_vds_1, inner_connection_g1[1]);
