#include "cla_engine_instance.hpp"
...
extern "C" {
    void cla_engine(    const ap_uint<64>          *data1,
...
#pragma HLS INTERFACE m_axi port = data8 offset = slave bundle = gmem8 num_read_outstanding=64  max_read_burst_length=2 latency=118
        ...
        cla_engine_instance(data1, in_cmd1, in_ctrl1, out_data1);
        cla_engine_instance(data2, in_cmd2, in_ctrl2, out_data2);
        cla_engine_instance(data3, in_cmd3, in_ctrl3, out_data3);
        cla_engine_instance(data4, in_cmd4, in_ctrl4, out_data4);
        cla_engine_instance(data5, in_cmd5, in_ctrl5, out_data5);
        cla_engine_instance(data6, in_cmd6, in_ctrl6, out_data6);
        cla_engine_instance(data7, in_cmd7, in_ctrl7, out_data7);
        cla_engine_instance(data8, in_cmd8, in_ctrl8, out_data8);
