...
extern "C" {
    void cla_out(       mem_access_stream_t(64)         &in_data_0,
...
#pragma HLS dataflow
        ...
        rpa_task_frp_inner_stream_t     inner_connection_g1[2];
...
#pragma HLS stream variable=frp_out  depth=13
        ...
        cla_out_frp(in_data_0, in_vds_0, inner_connection_g1[0]);
        cla_out_frp(in_data_1, in_vds_1, inner_connection_g1[1]);

        merge_package< FRP_TEMPLATE(rpa_task) >(
