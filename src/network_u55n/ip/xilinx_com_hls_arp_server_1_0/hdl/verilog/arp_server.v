...
(* CORE_GENERATION_INFO="arp_server_arp_server,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu55n-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.100000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.612000,HLS_SYN_LAT=6,HLS_SYN_TPT=2,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1186,HLS_SYN_LUT=1765,HLS_VERSION=2021_2}" *)
